<x-layout>
    <div class="w3-container">
        ...
        <form action="{{ route('subscriptions.store') }}" method="POST" class="w3-container w3-card-4">
            @csrf
            ...
            <div class="w3-margin">
                ...
                <input type="number" name="points" id="points" class="w3-input w3-border" min="0" required>
            </div>

            <div class="w3-margin">
                <button type="submit" class="w3-button w3-blue">Criar Inscrição</button>
