<x-layout>
    <div class="w3-container">
        <h1 class="w3-text-blue">Create New Room</h1>
        ...
        <form action="{{ route('rooms.store') }}" method="POST" class="w3-container w3-card-4 w3-light-grey">
            @csrf
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input w3-border" type="text" name="topic" value="{{ old('topic') }}" required>
            </div>
